...
export default function CampaignForm({ onSubmit, initialData, isSubmitting = false, campaignId }: CampaignFormProps) {
    ...
    const validateForm = (): boolean => {
        ...
        requiredFields.forEach(field => {
            if (!formData[field] || (field === 'proposed_policies' && formData[field] === '<p><br></p>')) {
    ...
    const regionTooltipText = "The geographic area where an election is held. Only registered voters within this region are eligible to vote. Enter the city for local elections, the state for state elections, or the country for national elections.";
        ...
        <form onSubmit={handleSubmit} noValidate>
            <div className="row g-4">
                ...
                <div className="col-md-6">
                    <label htmlFor="election_region" className="form-label">
                        <Tooltip text={regionTooltipText}>
                            <span>Election Region (?)</span>
                        </Tooltip>
                    </label>
                    <input type="text" id="election_region" name="election_region" value={formData.election_region} onChange={handleChange} className={`form-control ${errors.election_region ? 'is-invalid' : ''}`} placeholder={getRegionPlaceholder()} required aria-invalid={!!errors.election_region} aria-describedby="election_region-error" />
            ...
            <div className="mt-4">
                ...
                <div className="form-text mb-2 text-secondary">
            ...
            <div className="mt-4">
                <label id="policies-label" className="form-label">Proposed Policies</label>
                ...
                <QuillEditor value={formData.proposed_policies} onChange={handleQuillChange} ariaLabelledBy="policies-label" />
                {errors.proposed_policies && <div className="text-danger mt-1 text-sm">{errors.proposed_policies}</div>}
            </div>
