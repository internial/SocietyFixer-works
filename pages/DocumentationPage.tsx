...
// By embedding the documentation content directly, we prevent potential
// fetch errors if the .txt file is not served correctly by the hosting environment.
const docContent = `=========================================
...
9. Deprecated Files
-------------------
The following files are empty, unused, and are slated for deletion in a future cleanup. They are not imported by any part of the application and can be safely ignored.

- \`components/WelcomeModal.tsx\`
- \`pages/UpdatePasswordPage.tsx\`
- \`components/SupabaseNotConfigured.tsx\`
- \`pages/BlogPostPage.tsx\``;

/**
 * A page that displays the project's developer documentation.
 * The content is now embedded directly in the component to prevent network errors.
